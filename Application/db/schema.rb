...
ActiveRecord::Schema.define(version: 2018_10_25_141817) do
  ...
  create_table "middles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_middles_on_doctor_id"
    t.index ["specialty_id"], name: "index_middles_on_specialty_id"
  end
